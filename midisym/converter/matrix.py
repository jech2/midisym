...
def sym_to_pr_mat(sym_obj: SymMusicContainer, 
                  sym_data_type: str ="analyzed performance MIDI",
                  value: str = 'duration', 
    ...
    pr_mat = make_grid_quantized_note_prmat(sym_obj=sym_obj, grid=grid, value=value, pitch_range=pitch_range, inst_ids=inst_ids, do_slicing=do_slicing)
    return pr_mat
