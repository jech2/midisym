...
def get_grid_quantized_time_mat(sym_obj: SymMusicContainer, add_chord_labels_to_pr=True, chord_style='chorder', sym_data_type="analyzed performance MIDI -- grid from ticks", melody_inst_ids=[MELODY]):  
    sym_obj, grid = make_grid_quantized_notes(
        sym_obj=sym_obj,
        sym_data_type=sym_data_type,
    )
    ...
    arr_mat = make_grid_quantized_note_prmat(sym_obj, grid, value='onset_frame', pitch_range=(21, 108), inst_ids=[MELODY, BRIDGE, PIANO])
